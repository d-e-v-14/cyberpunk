  ...
  return (
    <div className="relative w-full min-h-screen bg-black overflow-hidden font-sans">
      ...
      >
        ...
        <div className="relative w-full flex items-start justify-between px-10 -mt-8 md:-mt-10 lg:-mt-12">
          {/* LEFT: Stories & Lore */}
          <div
            className="hidden md:flex flex-col justify-start max-w-xs z-20"
            style={{
              minWidth: 200,
              marginTop: "180px",
            }}
          >
            ...
            <div className="mt-6 flex items-center gap-0">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, transparent, #e85d04 60%, #e85d04)",
                  width: 80,
                }}
              />
              <div
            ...
            <div
              className="mt-10 w-10 h-10 rounded-full flex-shrink-0"
              style={{
                background:
                  "radial-gradient(circle, #f5c518 0%, #e85d04 60%, transparent 100%)",
      ...
      <div
        ...
        style={{
          width: 1,
          background:
            "linear-gradient(180deg, transparent 0%, rgba(59,130,246,0.12) 30%, rgba(59,130,246,0.12) 70%, transparent 100%)",
        }}
      />
      <div
      ...
      <div
        ...
        style={{
          ...
          height: "70%",
          background:
            "radial-gradient(ellipse at center, rgba(30,30,60,0.45) 0%, transparent 75%)",
          borderRadius: "50%",
        }}
      />
    </div>
